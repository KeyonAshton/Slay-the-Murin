...
import gigimurin.util.TexLoader;
...
public abstract class AbstractEasyPower extends AbstractPower {
    ...
    public AbstractEasyPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        ...
        Texture normalTexture = TexLoader.getTexture(GigiMurinMain.modID + "Resources/images/powers/" + ID.replaceAll(GigiMurinMain.modID + ":", "") + "32.png");
        Texture hiDefImage = TexLoader.getTexture(GigiMurinMain.modID + "Resources/images/powers/" + ID.replaceAll(GigiMurinMain.modID + ":", "") + "84.png");
        if (hiDefImage != null) {
