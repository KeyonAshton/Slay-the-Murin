...
import gigimurin.util.CardArtRoller;

import static gigimurin.GigiMurinMain.makeImagePath;
import static gigimurin.GigiMurinMain.modID;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, GigiMurinChar.Enums.GIGI_COLOR);
    }
