...
public class GigiMurinChar extends CustomPlayer {
    ...
    public AbstractPlayer newInstance() {
        return new GigiMurinChar(name, chosenClass);
    }
    ...
    public static class Enums {
        //TODO: Change these.
        @SpireEnum
        public static AbstractPlayer.PlayerClass GIGI_MURIN;
        @SpireEnum(name = "GIGI_MURIN")
        public static AbstractCard.CardColor GIGI_COLOR;
        @SpireEnum(name = "GIGI_MURIN")
