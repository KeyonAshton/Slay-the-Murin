...
import gigimurin.cards.cardvars.AbstractEasyDynamicVariable;
import gigimurin.potions.AbstractEasyPotion;
import gigimurin.relics.AbstractEasyRelic;
import gigimurin.util.ProAudio;
import java.nio.charset.StandardCharsets;

@SuppressWarnings({"unused", "WeakerAccess"})
@SpireInitializer
public class GigiMurinMain implements
        EditCardsSubscriber,
    ...
    public static final String modID = "gigimurin";

    public static String makeID(String idText) {
        return modID + ":" + idText;
    }

    public static Color characterColor = new Color(0.953f, 0.745f, 0.341f, 1);
    ...
    public GigiMurinMain() {
        BaseMod.subscribe(this);

        BaseMod.addColor(GigiMurinChar.Enums.GIGI_COLOR, characterColor, characterColor, characterColor,
    ...
    public static void initialize() {
        GigiMurinMain gigimod = new GigiMurinMain();
    }

    @Override
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new GigiMurinChar(GigiMurinChar.characterStrings.NAMES[1], GigiMurinChar.Enums.GIGI_MURIN),
            CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, GigiMurinChar.Enums.GIGI_MURIN);
