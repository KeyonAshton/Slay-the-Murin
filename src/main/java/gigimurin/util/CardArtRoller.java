package gigimurin.util;

import basemod.patches.whatmod.WhatMod;
import gigimurin.GigiMurinMain;
...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(GigiMurinMain.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(GigiMurinMain.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(GigiMurinMain.makeImagePath("masks/PowerMask.png"));
